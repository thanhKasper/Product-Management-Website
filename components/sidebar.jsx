    ...
    >
      ...
      <ul className="w-full flex flex-col gap-3">
        <SidebarOpt
          text="Product"
          bgColor={
            currentPage == "Product" ? "bg-accent1-100 text-white font-medium" : ""
          }
          link="/products"
        >
          <svg
        ...
        <SidebarOpt
          text="Order"
          bgColor={
            currentPage == "Order" ? "bg-accent1-100 text-white font-medium" : ""
          }
          link="/orders"
        >
          <svg
        ...
        <SidebarOpt
          text="Customer"
          bgColor={
            currentPage == "Customer" ? "bg-accent1-100 text-white font-medium" : ""
          }
          link="/customers"
        >
          <svg
      ...
      <button className="bg-accent2-200 text-white w-full py-3 rounded-sm font-semibold">
        Log Out
      </button>
    </div>
  );
